...
#define PI_PIF_DT_CHAR 3U
  ...
  int PI_FUNC_DECL PI_OpenRS232DaisyChain(int iPortNumber,
                                          int iBaudRate,
  ...
  int PI_FUNC_DECL PI_OpenRS232DaisyChainByDevName(const char* szDevName,
                                                   int iBaudRate,
                                                   int* pNumberOfConnectedDaisyChainDevices,
                                                   char* szDeviceIDNs,
                                                   int iBufferSize);
  ...
  int PI_FUNC_DECL PI_OpenTCPIPDaisyChain(const char* szHostname,
                                          int port,
                                          int* pNumberOfConnectedDaisyChainDevices,
                                          char* szDeviceIDNs,
                                          int iBufferSize);
  ...
  int PI_FUNC_DECL PI_OpenUSBDaisyChain(const char* szDescription,
                                        int* pNumberOfConnectedDaisyChainDevices,
                                        char* szDeviceIDNs,
                                        int iBufferSize);
  ...
  BOOL PI_FUNC_DECL PI_IFS(int ID,
  ...
  BOOL PI_FUNC_DECL PI_ATZ(int ID,
                           const char* szAxes,
  ...
  BOOL PI_FUNC_DECL PI_GetErrorStatus(int ID,
  ...
  BOOL PI_FUNC_DECL PI_SPA(int ID,
                           const char* szItems,
                           const unsigned int* iParameterArray,
                           const double* pdValueArray,
                           const char* szStrings);
  BOOL PI_FUNC_DECL PI_qSPA(int ID,
                            const char* szItems,
                            unsigned int* iParameterArray,
                            double* pdValueArray,
                            char* szStrings,
                            int iMaxNameSize);
  BOOL PI_FUNC_DECL PI_SEP(int ID,
                           const char* szPassword,
                           const char* szItems,
                           const unsigned int* iParameterArray,
                           const double* pdValueArray,
                           const char* szStrings);
  BOOL PI_FUNC_DECL PI_qSEP(int ID,
                            const char* szItems,
                            unsigned int* iParameterArray,
                            double* pdValueArray,
                            char* szStrings,
                            int iMaxNameSize);
  BOOL PI_FUNC_DECL PI_WPA(int ID,
                           const char* szPassword,
                           const char* szItems,
                           const unsigned int* iParameterArray);
  BOOL PI_FUNC_DECL PI_DPA(int ID,
                           const char* szPassword,
                           const char* szItems,
                           const unsigned int* iParameterArray);
  ...
  BOOL PI_FUNC_DECL PI_SPA_String(int ID,
                                  const char* szItems,
                                  const unsigned int* iParameterArray,
                                  const char* szStrings);
  BOOL PI_FUNC_DECL PI_qSPA_String(int ID,
                                   const char* szItems,
                                   const unsigned int* iParameterArray,
                                   char* szStrings,
                                   int iMaxNameSize);
  BOOL PI_FUNC_DECL PI_SEP_String(int ID,
                                  const char* szPassword,
                                  const char* szItems,
                                  const unsigned int* iParameterArray,
                                  const char* szStrings);
  BOOL PI_FUNC_DECL PI_qSEP_String(
    int ID, const char* szItems, unsigned int* iParameterArray, char* szStrings, int iMaxNameSize);
  BOOL PI_FUNC_DECL PI_SPA_int64(int ID,
                                 const char* szItems,
                                 const unsigned int* iParameterArray,
                                 const __int64* piValueArray);
  BOOL PI_FUNC_DECL PI_qSPA_int64(int ID,
                                  const char* szItems,
                                  unsigned int* iParameterArray,
                                  __int64* piValueArray);
  BOOL PI_FUNC_DECL PI_SEP_int64(int ID,
                                 const char* szPassword,
                                 const char* szItems,
                                 const unsigned int* iParameterArray,
                                 const __int64* piValueArray);
  BOOL PI_FUNC_DECL PI_qSEP_int64(int ID,
                                  const char* szItems,
                                  unsigned int* iParameterArray,
                                  __int64* piValueArray);
  ...
  BOOL PI_FUNC_DECL
  PI_qATS(int ID, const int* piChannels, const int* piOptions, int* piValueArray, int iArraySize);
  ...
  BOOL PI_FUNC_DECL PI_MAC_NSTART_Args(int ID,
  ...
  BOOL PI_FUNC_DECL PI_qVMO(int ID,
                            const char* szAxes,
  ...
  /////////////////////////////////////////////////////////////////////////////
  // Wave commands.
  BOOL PI_FUNC_DECL PI_IsGeneratorRunning(int ID,
                                          const int* piWaveGeneratorIds,
                                          BOOL* pbValueArray,
                                          int iArraySize);
  BOOL PI_FUNC_DECL PI_qTWG(int ID, int* piWaveGenerators);
  BOOL PI_FUNC_DECL PI_WAV_SIN_P(int ID,
                                 int iWaveTableId,
                                 ...
                                 int iSegmentLength);
  BOOL PI_FUNC_DECL PI_WAV_LIN(int ID,
                               int iWaveTableId,
                               int iOffsetOfFirstPointInWaveTable,
                               int iNumberOfPoints,
                               int iAddAppendWave,
                               ...
                               double dOffsetOfWave,
                               int iSegmentLength);
  BOOL PI_FUNC_DECL PI_WAV_NOISE(int ID,
                                 int iWaveTableId,
                                 int iAddAppendWave,
                                 double dAmplitudeOfWave,
                                 double dOffsetOfWave,
                                 int iSegmentLength);
  BOOL PI_FUNC_DECL PI_WAV_SWEEP(int ID,
                                 int iWaveTableId,
                                 int iAddAppendWave,
                                 ...
                                 double dAmplitudeOfWave,
                                 double dOffsetOfWave);
  BOOL PI_FUNC_DECL PI_WAV_RAMP(int ID,
                                int iWaveTableId,
                                int iOffsetOfFirstPointInWaveTable,
                                int iNumberOfPoints,
                                int iAddAppendWave,
                                ...
                                double dOffsetOfWave,
                                int iSegmentLength);
  BOOL PI_FUNC_DECL PI_WAV_PNT(int ID,
                               int iWaveTableId,
                               int iOffsetOfFirstPointInWaveTable,
                               int iNumberOfPoints,
                               int iAddAppendWave,
                               const double* pdWavePoints);
  BOOL PI_FUNC_DECL PI_qWAV(int ID,
                            const int* piWaveTableIdsArray,
                            const int* piParamereIdsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_WGO(int ID,
                           const int* piWaveGeneratorIdsArray,
                           const int* iStartModArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qWGO(int ID,
                            const int* piWaveGeneratorIdsArray,
                            int* piValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_WGC(int ID,
                           const int* piWaveGeneratorIdsArray,
                           const int* piNumberOfCyclesArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qWGC(int ID,
                            const int* piWaveGeneratorIdsArray,
                            int* piValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_qWGI(int ID,
                            const int* piWaveGeneratorIdsArray,
                            int* piValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_qWGN(int ID,
                            const int* piWaveGeneratorIdsArray,
                            int* piValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL
  PI_qWGS(int ID, int iWaveGeneratorId, const char* szItem, char* buffer, int bufferSize);
  BOOL PI_FUNC_DECL PI_WSL(int ID,
                           const int* piWaveGeneratorIdsArray,
                           const int* piWaveTableIdsArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qWSL(int ID,
                            const int* piWaveGeneratorIdsArray,
                            int* piWaveTableIdsArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_DTC(int ID, const int* piDdlTableIdsArray, int iArraySize);
  BOOL PI_FUNC_DECL PI_qDTL(int ID,
  ...
  BOOL PI_FUNC_DECL PI_qGWD_SYNC(int ID,
                                 int iWaveTableId,
                                 int iOffsetOfFirstPointInWaveTable,
                                 int iNumberOfValues,
                                 double* pdValueArray);
  BOOL PI_FUNC_DECL PI_qGWD(int ID,
  ...
  BOOL PI_FUNC_DECL PI_WOS(int ID,
                           const int* iWaveTableIdsArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qWOS(int ID,
                            const int* iWaveTableIdsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_WTR(int ID,
                           const int* piWaveGeneratorIdsArray,
                           const int* piTableRateArray,
                           const int* piInterpolationTypeArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qWTR(int ID,
                            const int* piWaveGeneratorIdsArray,
                            int* piTableRateArray,
                            int* piInterpolationTypeArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_DDL(int ID,
                           int iDdlTableId,
                           int iOffsetOfFirstPointInDdlTable,
                           int iNumberOfValues,
                           const double* pdValueArray);
  BOOL PI_FUNC_DECL PI_qDDL_SYNC(int ID,
                                 int iDdlTableId,
                                 int iOffsetOfFirstPointInDdlTable,
                                 int iNumberOfValues,
                                 double* pdValueArray);
  BOOL PI_FUNC_DECL PI_qDDL(int ID,
  ...
  BOOL PI_FUNC_DECL PI_qTWS(int ID,
                            ...
                            char* szGcsArrayHeader,
                            int iGcsArrayHeaderMaxSize);
  BOOL PI_FUNC_DECL PI_CTO(int ID,
                           const int* piTriggerOutputIds,
                           const int* piTriggerParameterArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_CTOString(int ID,
                                 const int* piTriggerOutputIds,
                                 const int* piTriggerParameterArray,
                                 const char* szValueArray,
                                 int iArraySize);
  BOOL PI_FUNC_DECL PI_qCTO(int ID,
                            const int* piTriggerOutputIds,
                            const int* piTriggerParameterArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_qCTOString(int ID,
                                  const int* piTriggerOutputIds,
                                  const int* piTriggerParameterArray,
                                  char* szValueArray,
                                  int iArraySize,
                                  int iBufferSize);
  BOOL PI_FUNC_DECL PI_TRO(int ID,
                           const int* piTriggerOutputIds,
                           const BOOL* pbTriggerState,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qTRO(int ID,
                            const int* piTriggerOutputIds,
                            BOOL* pbTriggerState,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_TRI(int ID,
                           const int* piTriggerInputIds,
                           const BOOL* pbTriggerState,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qTRI(int ID,
                            const int* piTriggerInputIds,
                            BOOL* pbTriggerState,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_CTI(int ID,
                           const int* piTriggerInputIds,
                           const int* piTriggerParameterArray,
                           const char* szValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qCTI(int ID,
                            const int* piTriggerInputIds,
                            const int* piTriggerParameterArray,
                            char* szValueArray,
                            int iArraySize,
  ...
  BOOL PI_FUNC_DECL PI_qDRR(int ID,
                            ...
                            char* szGcsArrayHeader,
                            int iGcsArrayHeaderMaxSize);
  BOOL PI_FUNC_DECL PI_DRT(int ID,
                           const int* piRecordChannelIdsArray,
                           const int* piTriggerSourceArray,
                           const char* szValues,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qDRT(int ID,
                            const int* piRecordChannelIdsArray,
  ...
  BOOL PI_FUNC_DECL PI_qDRL(int ID,
                            const int* piRecordChannelIdsArray,
  ...
  BOOL PI_FUNC_DECL PI_qGFR(int ID,
                            ...
                            char* szGcsArrayHeader,
                            int iGcsArrayHeaderMaxSize);
  BOOL PI_FUNC_DECL PI_WFR(int ID,
                           const char* szAxis,
                           double dPos,
                           int iSource,
                           double dAmpl,
  ...
  BOOL PI_FUNC_DECL PI_VMA(int ID,
                           const int* piPiezoChannelsArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qVMA(int ID,
                            const int* piPiezoChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_VMI(int ID,
                           const int* piPiezoChannelsArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qVMI(int ID,
                            const int* piPiezoChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_VOL(int ID,
                           const int* piPiezoChannelsArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qVOL(int ID,
                            const int* piPiezoChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_qTPC(int ID, int* piNumberOfPiezoChannels);
  BOOL PI_FUNC_DECL PI_ONL(int ID,
  ...
  BOOL PI_FUNC_DECL PI_qTAD(int ID,
                            const int* piSensorsChannelsArray,
                            int* piValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_qTNS(int ID,
                            const int* piSensorsChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_TSP(int ID,
                           const int* piSensorsChannelsArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qTSP(int ID,
                            const int* piSensorsChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_SCN(int ID,
                           const int* piSensorsChannelsArray,
                           const int* piValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qSCN(int ID,
                            const int* piSensorsChannelsArray,
                            int* piValueArray,
                            int iArraySize);
  ...
  BOOL PI_FUNC_DECL PI_qAPG(int ID,
                            const int* piPIEZOWALKChannelsArray,
                            int* piValueArray,
                            int iArraySize);

  BOOL PI_FUNC_DECL PI_OAC(int ID,
                           const int* piPIEZOWALKChannelsArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qOAC(int ID,
                            const int* piPIEZOWALKChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_OAD(int ID,
                           const int* piPIEZOWALKChannelsArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qOAD(int ID,
                            const int* piPIEZOWALKChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_ODC(int ID,
                           const int* piPIEZOWALKChannelsArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qODC(int ID,
                            const int* piPIEZOWALKChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_OCD(int ID,
                           const int* piPIEZOWALKChannelsArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qOCD(int ID,
                            const int* piPIEZOWALKChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_OSM(int ID,
                           const int* piPIEZOWALKChannelsArray,
                           const int* piValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qOSM(int ID,
                            const int* piPIEZOWALKChannelsArray,
                            int* piValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_OSMf(int ID,
                            const int* piPIEZOWALKChannelsArray,
                            const double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_qOSMf(int ID,
                             const int* piPIEZOWALKChannelsArray,
                             double* pdValueArray,
                             int iArraySize);
  BOOL PI_FUNC_DECL PI_OSMstringIDs(int ID,
                                    const char* szAxisOrChannelIds,
                                    const double* pdValueArray);
  BOOL PI_FUNC_DECL PI_qOSMstringIDs(int ID, const char* szAxisOrChannelIds, double* pdValueArray);
  BOOL PI_FUNC_DECL PI_OVL(int ID,
                           const int* piPIEZOWALKChannelsArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qOVL(int ID,
                            const int* piPIEZOWALKChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_qOSN(int ID,
                            const int* piPIEZOWALKChannelsArray,
                            int* piValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_qOSNstringIDs(int ID, const char* szAxisOrChannelIds, int* piValueArray);
  BOOL PI_FUNC_DECL PI_SSA(int ID,
                           const int* piPIEZOWALKChannelsArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qSSA(int ID,
                            const int* piPIEZOWALKChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_RNP(int ID,
                           const int* piPIEZOWALKChannelsArray,
                           const double* pdValueArray,
                           int iArraySize);
  ...
  BOOL PI_FUNC_DECL PI_qTAV(int ID,
                            const int* piChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  ...
  /////////////////////////////////////////////////////////////////////////////
  // Joystick
  BOOL PI_FUNC_DECL PI_qJAS(int ID,
  ...
  BOOL PI_FUNC_DECL PI_qJAX(int ID,
                            const int* iJoystickIDsArray,
                            const int* iAxesIDsArray,
                            int iArraySize,
                            char* szAxesBuffer,
                            int iBufferSize);
  BOOL PI_FUNC_DECL PI_qJBS(int ID,
                            const int* iJoystickIDsArray,
                            const int* iButtonIDsArray,
                            BOOL* pbValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_JDT(int ID,
                           const int* iJoystickIDsArray,
                           const int* iAxisIDsArray,
                           const int* piValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_JLT(int ID,
                           int iJoystickID,
                           int iAxisID,
                           int iStartAdress,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qJLT(int ID,
                            const int* iJoystickIDsArray,
                            const int* iAxisIDsArray,
                            int iNumberOfTables,
                            int iOffsetOfFirstPointInTable,
                            ...
                            char* szGcsArrayHeader,
                            int iGcsArrayHeaderMaxSize);
  BOOL PI_FUNC_DECL PI_JON(int ID,
                           const int* iJoystickIDsArray,
                           const BOOL* pbValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qJON(int ID,
                            const int* iJoystickIDsArray,
                            BOOL* pbValueArray,
                            int iArraySize);
  ...
  /////////////////////////////////////////////////////////////////////////////
  // fast scan commands
  BOOL PI_FUNC_DECL PI_AAP(int ID,
                           const char* szAxis1,
                           double dLength1,
                           const char* szAxis2,
                           double dLength2,
                           ...
                           int iAnalogInput);
  BOOL PI_FUNC_DECL PI_FIO(int ID,
                           const char* szAxis1,
                           double dLength1,
                           const char* szAxis2,
                           double dLength2,
                           ...
                           double dAngleScan,
                           int iAnalogInput);
  BOOL PI_FUNC_DECL PI_FLM(int ID,
                           const char* szAxis,
                           double dLength,
                           double dThreshold,
                           int iAnalogInput,
                           int iDirection);
  BOOL PI_FUNC_DECL PI_FLS(int ID,
                           const char* szAxis,
                           double dLength,
                           double dThreshold,
                           int iAnalogInput,
                           int iDirection);
  BOOL PI_FUNC_DECL PI_FSA(int ID,
                           const char* szAxis1,
                           double dLength1,
                           const char* szAxis2,
                           double dLength2,
                           ...
                           double dAlignStep,
                           int iAnalogInput);
  BOOL PI_FUNC_DECL PI_FSC(int ID,
                           const char* szAxis1,
                           double dLength1,
                           const char* szAxis2,
                           double dLength2,
                           ...
                           double dDistance,
                           int iAnalogInput);
  BOOL PI_FUNC_DECL PI_FSM(int ID,
                           const char* szAxis1,
                           double dLength1,
                           const char* szAxis2,
                           double dLength2,
  ...
  BOOL PI_FUNC_DECL PI_FDR(int ID,
                           ...
                           const char* szParameters);
  BOOL PI_FUNC_DECL PI_FDG(int ID,
                           const char* szScanRoutineName,
                           const char* szScanAxis,
                           const char* szStepAxis,
                           const char* szParameters);
  ...
  BOOL PI_FUNC_DECL
  PI_qFRR(int ID, const char* szScanRoutineNames, int iResultId, char* szResult, int iBufferSize);
  BOOL PI_FUNC_DECL PI_qFRRArray(
    int ID, const char* szScanRoutineNames, const int* iResultIds, char* szResult, int iBufferSize);
  BOOL PI_FUNC_DECL PI_qFRH(int ID, char* szBuffer, int iBufferSize);

  /////////////////////////////////////////////////////////////////////////////
  // optical boards (hexapod)
  BOOL PI_FUNC_DECL PI_SGA(int ID,
                           const int* piAnalogChannelIds,
                           const int* piGainValues,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qSGA(int ID,
                            const int* piAnalogChannelIds,
                            int* piGainValues,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_NAV(int ID,
                           const int* piAnalogChannelIds,
                           const int* piNrReadingsValues,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qNAV(int ID,
                            const int* piAnalogChannelIds,
  ...
  /////////////////////////////////////////////////////////////////////////////
  // PIShift
  BOOL PI_FUNC_DECL PI_qCOV(int ID,
                            const int* piChannelsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_MOD(int ID,
                           const char* szItems,
                           const unsigned int* iModeArray,
                           const char* szValues);
  BOOL PI_FUNC_DECL PI_qMOD(int ID,
                            const char* szItems,
                            const unsigned int* iModeArray,
                            char* szValues,
                            int iMaxValuesSize);
  ...
  BOOL PI_FUNC_DECL
  PI_qDIA(int ID, const unsigned int* iIDArray, char* szValues, int iBufferSize, int iArraySize);
  ...
  BOOL PI_FUNC_DECL PI_HIS(int ID,
                           const int* iDeviceIDsArray,
                           const int* iItemIDsArray,
                           const int* iPropertyIDArray,
                           const char* szValues,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qHIE(int ID,
                            const int* iDeviceIDsArray,
                            const int* iAxesIDsArray,
                            double* pdValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_qHIB(int ID,
                            const int* iDeviceIDsArray,
                            const int* iButtonIDsArray,
                            int* pbValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_HIL(int ID,
                           const int* iDeviceIDsArray,
                           const int* iLED_IDsArray,
                           const int* pnValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qHIL(int ID,
                            const int* iDeviceIDsArray,
                            const int* iLED_IDsArray,
                            int* pnValueArray,
                            int iArraySize);
  ...
  BOOL PI_FUNC_DECL PI_HIA(int ID,
                           const char* szAxes,
                           const int* iFunctionArray,
                           const int* iDeviceIDsArray,
                           const int* iAxesIDsArray);
  BOOL PI_FUNC_DECL PI_qHIA(int ID,
                            const char* szAxes,
                            const int* iFunctionArray,
                            int* iDeviceIDsArray,
                            int* iAxesIDsArray);
  BOOL PI_FUNC_DECL PI_HDT(int ID,
                           const int* iDeviceIDsArray,
                           const int* iAxisIDsArray,
                           const int* piValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qHDT(int ID,
                            const int* iDeviceIDsArray,
                            const int* iAxisIDsArray,
                            int* piValueArray,
                            int iArraySize);
  BOOL PI_FUNC_DECL PI_HIT(int ID,
                           const int* piTableIdsArray,
                           const int* piPointNumberArray,
                           const double* pdValueArray,
                           int iArraySize);
  BOOL PI_FUNC_DECL PI_qHIT(int ID,
                            const int* piTableIdsArray,
                            int iNumberOfTables,
                            int iOffsetOfFirstPointInTable,
                            int iNumberOfValues,
  ...
  BOOL PI_FUNC_DECL PI_KSD(int ID,
                           const char* szNameOfCoordSystem,
                           const char* szAxes,
                           const double* pdValueArray);
  BOOL PI_FUNC_DECL PI_KST(int ID,
                           const char* szNameOfCoordSystem,
                           const char* szAxes,
                           const double* pdValueArray);
  BOOL PI_FUNC_DECL PI_KSW(int ID,
                           const char* szNameOfCoordSystem,
                           const char* szAxes,
                           const double* pdValueArray);
  BOOL PI_FUNC_DECL PI_KLD(int ID,
                           const char* szNameOfCoordSystem,
                           const char* szAxes,
                           const double* pdValueArray);
  BOOL PI_FUNC_DECL PI_KSB(int ID,
                           const char* szNameOfCoordSystem,
                           const char* szAxes,
                           const double* pdValueArray);
  ...
  BOOL PI_FUNC_DECL PI_qKLT(int ID,
  ...
  BOOL PI_FUNC_DECL PI_qKLS(int ID,
                            const char* szNameOfCoordSystem,
                            const char* szItem1,
                            const char* szItem2,
                            char* buffer,
  ...
  BOOL PI_FUNC_DECL PI_qTRA(int ID,
                            const char* szAxes,
                            const double* pdComponents,
                            double* pdValueArray);
  BOOL PI_FUNC_DECL PI_qKLC(int ID,
  ...
  /////////////////////////////////////////////////////////////////////////////
  // Trajectory
  BOOL PI_FUNC_DECL PI_TGA(int ID,
  ...
  BOOL PI_FUNC_DECL PI_qTGL(int ID,
                            const int* piTrajectoriesArray,
  ...
  /////////////////////////////////////////////////////////////////////////////
  /// Surface scan
  BOOL PI_FUNC_DECL PI_FSF(int ID,
                           const char* szAxis,
                           double forceValue1,
                           double positionOffset,
                           BOOL useForceValue2,
                           double forceValue2);
  BOOL PI_FUNC_DECL PI_qFSF(int ID,
                            const char* szAxes,
  ...
  /////////////////////////////////////////////////////////////////////////////
  // Spezial
  BOOL PI_FUNC_DECL PI_GetSupportedParameters(int ID,
  ...
  BOOL PI_FUNC_DECL PI_WriteConfigurationFromDatabaseToController(int ID,
                                                                  const char* szFilter,
                                                                  const char* szConfigurationName,
                                                                  char* szWarnings,
                                                                  int warningsBufferSize);
  BOOL PI_FUNC_DECL PI_ReadConfigurationFromControllerToDatabase(int ID,
                                                                 const char* szFilter,
                                                                 const char* szConfigurationName,
                                                                 char* szWarnings,
                                                                 int warningsBufferSize);
  BOOL PI_FUNC_DECL PI_GetAvailableControllerConfigurationsFromDatabase(
    int ID, char* szConfigurationNames, int configurationNamesBufferSize);
